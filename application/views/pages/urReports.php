...
<div class="container-fluid">
    ...
    <?php 
        ...
        $userEnvelope=$this->User_model->show_urReports($user_id); 
    ...
    ?>	
        ...
        <div class="w-100">
            <div class="row mb-1 bg-white" style=" font-size:20px; border-radius:10px; box-shadow:2px 2px 20px #0B44B1">
                
                <div class="col-xl-1 mt-3">
                    <img alt="Logo" src="<?php echo $img;?>"  class="img-fluid bg-white shadow rounded mb-3" style="border:3px solid #999" width="150px;">
                </div>
                <?php if($this->session->userdata('type') == 'User') { ?>
                <div class="col-xl-11  mt-3">
                 <div style=" font-size:20px; border-radius:10px;">
                ...
                <? } ?>
                 <?php if($this->session->userdata('type') == 'Admin' || $this->session->userdata('type') == 'Manager') { ?>
                 <div class="col-xl-11 bg-white">
                    <ol class="breadcrumb bg-white float-right mt-3">
                        <li class="breadcrumb-item"><b style="font-size:22px; border:5px solid #c3bebe;" class="bg-secondary rounded shadow text-white py-2 px-3"><?php echo $userDet['user_email']; ?></b></li>
                    </ol>
                 </div>
                <?}?>
    ...
    <?php if($this->session->userdata('type') == 'Admin' || $this->session->userdata('type') == 'Manager') { ?>
        ...
        <div class="col-xl-12 mt-3">
            <div class="breadcrumb-holder bg-coffee py-2 shadow" style="background:#4f330f">
              <form method="post" action="user/add_urgent"  enctype="multipart/form-data">
                <b>
                    <div class="row mb-2">
                        <div class="btcd-f-input">
                            <div class="btcd-f-wrp">
                                ...
                                <span class="btcd-f-title text-white" style="text-shadow:2px 2px 10px #000">No File Chosen</span>
                                        ...
                                        <input type="file" name="file_name[]" multiple accept=".pdf" style="width:235px !important; border:4px solid #000; padding:4px; border-radius:10px; cursor:pointer !important" required/>
                                                    </div>
                    ...
                    <div class="row w-100">
                         <div class="col-md-10">
                            <button type="submit" class="btn btn-md w-100 btn btn-md rounded button shadow" style="background:#f0d8da;">
                                <i class="fa fa-cloud-upload" aria-hidden="true" style="font-size:25px"></i> 
                                    <span class="mb-3 font-weight-bold">ASSIGN URGENT REPORT TO 
                  ...
                  <!--<div class="row mx-auto">-->
                      <!--<div class="col-12 mx-auto">-->
                          <h2 class="card-title mb-0">
                            <span class="badge badge-danger p-3 shadow">Urgent Reports</span>
                          </h2>
                      <!--</div>-->
                      <!--</div>-->
                  </div>
        ...
        <div class="col-md-12 col-lg-12 col-xl-12">
            <div class="card">
              <div class="card-body" style="padding-bottom: 0 !important">
                <h4 class="card-title p-2 border border-info shadow rounded bg-light text-center font-weight-bold">ASSIGNED URGENT FILES</h4>
              </div>
              <div class="col-lg-12">
                            ...
                            <tr>
                               ...
                               <?}?>
                                ...
                                <td class=" text-center">
                                    ...
                                    <a href="https://wwww.gmail.com" target="_blank">
                                         <img wid src="/assets/images/gmail-512.webp" width="25px" alt="wa Icon"/>
                                    </a>
                                    <?php if($this->session->userdata('type') == 'Admin' || $this->session->userdata('type') == 'Manager') { ?>
                                    <span>|</span>
